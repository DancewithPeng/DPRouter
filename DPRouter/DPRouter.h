...
//! Project version number for DPRouter.
FOUNDATION_EXPORT double DPRouterVersionNumber;

//! Project version string for DPRouter.
FOUNDATION_EXPORT const unsigned char DPRouterVersionString[];
